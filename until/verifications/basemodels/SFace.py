...
def load_model(
    url="https://github.com/opencv/opencv_zoo/raw/main/models/face_recognition_sface/face_recognition_sface_2021dec"
        ".onnx",
):

    home = functions.get_home_path()

    file_name = home + "/weights/face_recognition_sface_2021dec.onnx"
